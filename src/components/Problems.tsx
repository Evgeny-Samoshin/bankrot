      ...
      <div className="container mx-auto px-4 max-w-7xl relative z-10">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {problems.map((prob, idx) => (
            ...
            >
              <div className="mx-auto bg-white w-16 h-16 rounded-2xl flex items-center justify-center shadow-sm mb-8 lg:group-hover:scale-110 transition-transform duration-500">
                {prob.icon}
              </div>
