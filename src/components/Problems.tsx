        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {problems.map((prob, idx) => (
            <motion.div 
              ...
              className="bg-brand-bg p-8 sm:p-10 rounded-[2rem] border border-brand-border/50 hover:shadow-xl hover:border-brand-accent/30 transition-colors duration-500 group text-center"
            >
              <div className="mx-auto bg-white w-16 h-16 rounded-2xl flex items-center justify-center shadow-sm mb-8 group-hover:scale-105 transition-transform duration-500">
                {prob.icon}
              </div>
