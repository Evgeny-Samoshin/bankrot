        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {cases.map((c, idx) => (
            <motion.div 
              ...
              className="bg-white p-8 sm:p-10 rounded-[2rem] border border-brand-border/50 shadow-lg hover:shadow-2xl hover:border-brand-accent/30 transition-colors duration-500 flex flex-col h-full group"
            >
